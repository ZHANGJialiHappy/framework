async function getSessions() {
  ...
  if (sessionsString !== undefined) sessionsArray = JSON.parse(sessionsString);
...
async function getAttempts() {
  ...
  return getSessions().then((sessionsArray) =>
    sessionsArray.reduce((acc, curr) => ++acc, 0)
  );
  // let sessionsArray = await getSessions();
